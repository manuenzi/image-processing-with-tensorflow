...
model = tm.train_model(model, train_images, train_labels, val_images, val_labels, 100)
model.save('saved_model\my_model')

# Load and excute model on new unseen images
...
temp_res = exm.execute_model(new_model, test_images)
